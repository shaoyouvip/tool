<?php /*a:1:{s:81:"/usr/home/shaoyou8/domains/tool.aizrf.com/application/admin/view/index/login.html";i:1722924448;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <form class="layui-form" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="captcha-img">
                <img id="captchaPic" src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?r='+Math.random();">
            </div>
        </div>
        <div class="layui-form-item">
